...
class MultiPostTransformer extends PageTransformer{
  MultiPostTransformer() : super(reverse: false);
...
class PostTransformer extends PageTransformer{
  PostTransformer() : super(reverse: false);
    ...
    if (position <= 0) {
      return new Opacity(
        ...
        child: new Transform.rotate(
          angle: position-(position/5),
          child: new Transform.translate(
            offset: new Offset(-position, info.width * -position),
            child: new Transform.scale(
              scale: 1.0,
              child: child,
            ),
